...
import { createButton } from "../helpers/button_helper.js";
...
const camera = viewer.camera; // Ensure this is accessible
  ...
  buttonContainer.style.top = '35%'; // Adjust top value as needed
  buttonContainer.style.left = '10px';
  buttonContainer.style.zIndex = '1000';
  document.body.appendChild(buttonContainer);
    
  createButton(2, 'Front View', [9, 4, -15], [0, 0, 0], buttonContainer, camera, controls);
  createButton(3, 'Top View', [8, -15, -14], [0, 0, 0], buttonContainer, camera, controls);
