...
const viewer = new GaussianSplats3D.Viewer({
    'cameraUp': [0, -1, 0],
    'initialCameraPosition': [1.21449, 0.95657, -5.48348],
    'initialCameraLookAt': [	0.23942, 2.87931, -1.13766],
...
viewer.addSplatScene('/assets/Breig_current_close.ksplat', {
...
const camera = viewer.camera; // Ensure this is accessible
  ...
  if (controls) {
    ...
    controls.maxDistance = 5.5; // Set maximum zoom distance
  ...
  createZoomButton(buttonContainer, 'zoom-out', GREY_BUTTON_COLORS, Paths.currentProjectSecondVisitHtmlPath);
